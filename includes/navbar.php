  ...
  <nav class="navbar navbar-static-top">
    <div class="container">
      <div class="navbar-header">
        <a href="#" class="navbar-brand"><b>Vote</b>Sphere</a>
        ...
        <ul class="nav navbar-nav">
          <?php
            if(isset($_SESSION['voter'])){
              echo "
                <li><a href='voters_panel.php'>HOME</a></li>
              ";
            }
          ?>
        </ul>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="#profile" data-toggle="modal" class="btn btn-default btn-flat" id="driver_profile">Update</a>
                </div>
